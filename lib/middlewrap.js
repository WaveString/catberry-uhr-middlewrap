...
export default function (uhr: Object): Object {
  ...
  const fixtures = [{
    url: 'http://bizaccount.prod.test/api/getUser/*',
    methods: 'GET,POST',
    routes: [{
      url: 'http://bizaccount.prod.test/api/getUser/morhetz',
      method: 'GET',
      result: { content: { id: '642jfkenr' } }
    }, {
      url: 'http://bizaccount.prod.test/api/getUser/morhetz',
      method: 'POST',
  ...
  registerVcr(wrappedUhr, modes.record, fixtures);
